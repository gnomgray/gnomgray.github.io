...
gdjs.New_32sceneCode.GDcodeObjects1= [];
gdjs.New_32sceneCode.GDcodeObjects2= [];
gdjs.New_32sceneCode.GDcodeObjects3= [];
...
gdjs.New_32sceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8192572);
}
...
gdjs.New_32sceneCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(8232260);
}
}}
...
};gdjs.New_32sceneCode.mapOfGDgdjs_46New_9532sceneCode_46GDPlayerHitBoxObjects1Objects = Hashtable.newFrom({"PlayerHitBox": gdjs.New_32sceneCode.GDPlayerHitBoxObjects1});gdjs.New_32sceneCode.mapOfGDgdjs_46New_9532sceneCode_46GDgoalObjects1Objects = Hashtable.newFrom({"goal": gdjs.New_32sceneCode.GDgoalObjects1});gdjs.New_32sceneCode.eventsList10 = function(runtimeScene) {
...
gdjs.New_32sceneCode.condition1IsTrue_0.val = false;
{
gdjs.New_32sceneCode.condition0IsTrue_0.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.New_32sceneCode.mapOfGDgdjs_46New_9532sceneCode_46GDPlayerHitBoxObjects1Objects, gdjs.New_32sceneCode.mapOfGDgdjs_46New_9532sceneCode_46GDgoalObjects1Objects, false, runtimeScene, false);
}if ( gdjs.New_32sceneCode.condition0IsTrue_0.val ) {
{
gdjs.New_32sceneCode.condition1IsTrue_0.val = gdjs.evtTools.common.getVariableNumber(runtimeScene.getVariables().getFromIndex(0)) == 1750;
}}
if (gdjs.New_32sceneCode.condition1IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("code"), gdjs.New_32sceneCode.GDcodeObjects1);
/* Reuse gdjs.New_32sceneCode.GDgoalObjects1 */
{for(var i = 0, len = gdjs.New_32sceneCode.GDcodeObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDcodeObjects1[i].setPosition(0,0);
}
}{for(var i = 0, len = gdjs.New_32sceneCode.GDgoalObjects1.length ;i < len;++i) {
    gdjs.New_32sceneCode.GDgoalObjects1[i].setAnimation(1);
}
}}
...
gdjs.New_32sceneCode.GDcodeObjects1.length = 0;
gdjs.New_32sceneCode.GDcodeObjects2.length = 0;
gdjs.New_32sceneCode.GDcodeObjects3.length = 0;
